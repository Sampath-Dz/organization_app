...
from auth.auth_server.utils import get_current_timestamp
from auth.auth_server.exceptions import NotFoundException, Err
    ...
    def get_by_id(self, record_id) -> ModelT:
        ...
        if not record:
            raise NotFoundException(
                Err.AUTH0003, [self.model_type.__name__, record_id]
            )
